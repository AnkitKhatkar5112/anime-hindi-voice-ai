...
- [-] 1. Wav2Lip installation and baseline test
  - [x] 1.1 Clone and install Wav2Lip with pretrained weights
    ...
    - _Requirements: 1_
  - [x] 1.2 Test Wav2Lip on a sample realistic face video
...
- [x] 2. Lip sync pipeline integration
  - [x] 2.1 Create `scripts/inference/lip_sync.py` wrapper script
    ...
    - _Requirements: 2_
  - [x] 2.2 Wire lip sync into `scripts/inference/run_pipeline.py` as Stage 7
...
- [x] 3. SadTalker evaluation for anime faces
  - [x] 3.1 Clone, install, and test SadTalker on anime character
    ...
    - _Requirements: 4_
  - [x] 3.2 Write comparison document `docs/lipsync_comparison.md`
