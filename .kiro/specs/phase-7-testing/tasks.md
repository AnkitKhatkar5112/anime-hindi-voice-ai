...
- [x] 2. Pipeline stage unit tests
  - [x] 2.1 Create `tests/test_extract_audio.py` — 5 assertions
    ...
    - _Requirements: 1, 3_
  - [x] 2.2 Create `tests/test_asr.py` — 4 assertions
    ...
    - _Requirements: 1, 3_
  - [x] 2.3 Create `tests/test_translate.py` — 4 assertions
    ...
    - _Requirements: 1, 3_
  - [x] 2.4 Create `tests/test_tts.py` — 4 assertions
...
- [x] 3. Output validation tests
  - [x] 3.1 Create `tests/test_align.py` — 3 assertions
    ...
    - _Requirements: 1, 3_
  - [x] 3.2 Create `tests/test_subtitles.py` — 3 assertions
...
- [x] 4. Quality benchmark
  - [x] 4.1 Create `scripts/evaluation/benchmark.py` for PESQ/STOI tracking
    ...
    - _Requirements: 5_
  - [x] 4.2 Verify full test suite passes within time budget
    - Run: `pytest tests/ -v`
