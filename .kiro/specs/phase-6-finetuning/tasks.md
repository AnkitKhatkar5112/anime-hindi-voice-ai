...
- [x] 1. Dataset preparation for TTS training
  - [x] 1.1 Create `scripts/training/prepare_dataset.py` for LJ-Speech format conversion
    ...
    - _Requirements: 1_
  - [x] 1.2 Add dataset summary and validation reporting
...
- [x] 2. VITS model fine-tuning on custom Hindi voice
  - [x] 2.1 Create `scripts/training/finetune_vits.py` for Coqui VITS fine-tuning
...
- [x] 3. Model evaluation and pipeline integration
  - [x] 3.1 Create `scripts/evaluation/compare_voices.py` for base vs fine-tuned comparison
    ...
    - _Requirements: 3_
  - [x] 3.2 Update pipeline to use fine-tuned model in `scripts/inference/tts_hindi.py`
