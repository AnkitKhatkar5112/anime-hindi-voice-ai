...
- [x] 1. FastAPI server setup and endpoint testing
  - [x] 1.1 Start the FastAPI server and test all endpoints
    ...
    - _Requirements: 1, 2_
  - [x] 1.2 Improve API error handling in `api/main.py`
...
- [x] 2. Streamlit UI testing and enhancement
  - [x] 2.1 Run and manually test the Streamlit UI
    ...
    - _Requirements: 3_
  - [x] 2.2 Add per-stage progress display to `ui/app.py`
...
- [x] 3. Batch processing
  - [x] 3.1 Test batch processor on a folder with 3+ episode files
